...
public class ParentUpdateDTO {
	...
	public ParentUpdateDTO(String name, String surname, Date dateOfBirth, String email, String jmbg, EUserGender gender,
			String phone, String streetNumber, String street, String city) {
		super();
		this.name = name;
		this.surname = surname;
		this.dateOfBirth = dateOfBirth;
