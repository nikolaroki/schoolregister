...
public class StudentDTO {
	...
	public StudentDTO(String name, String surname, Date dateOfBirth, String email, String jmbg, EUserGender gender,
			String streetNumber, String street, String city, String username, String password) {
		super();
		this.name = name;
		this.surname = surname;
		this.dateOfBirth = dateOfBirth;
